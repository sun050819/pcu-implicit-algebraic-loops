# -*- coding: utf-8 -*-
"""run_48_gate1_eainit_100seeds.py
Gate 1 decisive experiment: EA + PCU initialization vs pure EA (100 seeds).
...
# 100 seeds, paired across all conditions
...
def run_gate1():
    ...
    # Save results
    out_path = os.path.join(RESULTS, 'gate1_eainit_100seeds.json')
